...
?>
      ...
      <main >
              ...
              <form action="http://localhost:8080/hoc/admin/search.php">
              <div class="row">
                    <div class="col-4 " style="margin:auto;">
                    <div class="input-group">
                <input type="search" class="form-control rounded" placeholder="Search" aria-label="Search" value=""
                ...
                <table class="table">
                    ...
                    <tbody>
                      <?php 
                            ...
                            $sql =" SELECT * FROM can_bo ,don_vi WHERE can_bo.id_don_vi=don_vi.id_don_vi ";
